    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="ftco-nav">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item"><a href="add.php" class="nav-link">Ajout voiture</a></li>
                <?php
     ...
     <section class="ftco-section ftco-no-pt bg-light">
    	<div class="container">
    		<div class="row no-gutters">
                ...
                <form action=""  method="get" name="query" class="request-form ftco-animate bg-secondary">
                  <div class="form-group">
                    <input type="text" name="query" placeholder="Recherchez votre voiture..." class="form-control" required>
                  </div>
                  <div class="form-group">
                    <button type="submit" class="btn btn-primary py-3 px-4">Rehercher</button>
                  </div>
                </form>
	  					...
	  					<div class="col-md-8 d-flex align-items-center">
					        ...
					        <p><a href="#" class="btn btn-primary py-3 px-4">Reservez vos voiture parfaites</a></p>
	  						</div>
	  					</div>
	  				</div>
				</div>
