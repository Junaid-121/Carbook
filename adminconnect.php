...
<nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="ftco-nav">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item"><a href="add.php" class="nav-link">Ajouter une voiture</a></li>
                <?php
        ...
        <div class="container">
          <div class="row no-gutters slider-text js-fullheight align-items-end justify-content-start">
            <div class="col-md-9 ftco-animate pb-5">
                <p class="breadcrumbs"><span class="mr-2"><a href="index.php">Home <i class="ion-ios-arrow-forward"></i></a></span> <span>Connect <i class="ion-ios-arrow-forward"></i></span></p>
              <h1 class="mb-3 bread">Connect</h1>
            </div>
          </div>
        </div>
    </section>
    ...
    <section class="ftco-section contact-section">
                  ...
                  <div class="row mb-5">
                    <div class="col-md-12">
                        <div class="border w-100 p-4 rounded mb-2 d-flex">
                          ...
                          <p><span>Address:</span> Benin, Suite 721 Porto-Novo 10016</p>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="border w-100 p-4 rounded mb-2 d-flex">
                          ...
                          <p><span>Phone:</span> <a href="tel://43452406">+ 229 43452406</a></p>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="border w-100 p-4 rounded mb-2 d-flex">
        ...
        <p>Don't have an account yet? <a href="register.php" style="color: blue;">Click here</a></p>
    </form>
          </div>
