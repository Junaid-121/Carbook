        ...
        <div class="collapse navbar-collapse" id="ftco-nav">
            <ul class="navbar-nav ml-auto">
                ...
                <?php if (!isset($_SESSION['user_id'])): ?>
                    <li class="nav-item active"><a href="connect.php" class="nav-link">Se connecter</a></li>
                <?php else: ?>
        ...
        <div class="container">
          <div class="row no-gutters slider-text js-fullheight align-items-end justify-content-start">
            <div class="col-md-9 ftco-animate pb-5">
                <p class="breadcrumbs"><span class="mr-2"><a href="index.php">Acceuil <i class="ion-ios-arrow-forward"></i></a></span> <span>Connexion <i class="ion-ios-arrow-forward"></i></span></p>
        ...
        <div class="container">
          <div class="row d-flex mb-5 contact-info">
            ...
            <form action="login.php" method="post" class="bg-light p-5 contact-form">
              ...
              <div class="form-group">
                  <input type="submit" name="login" value="Se connecter" class="btn btn-primary py-3 px-5">
              </div>
              <p>Vous n'avez pas de compte ? <a href="register.php" style="color: blue;">Cliquez ici</a></p>
            </form>
          </div>
