	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
				...
				<li class="nav-item"><a href="connect.php" class="nav-link">Connect <i class="fas fa-person"></i></a></li>
			</ul>
	      </div>
	    </div>
	  </nav>
      ...
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-end justify-content-start">
          <div class="col-md-9 ftco-animate pb-5">
          	<p class="breadcrumbs"><span class="mr-2"><a href="index.php">Acceuil <i class="ion-ios-arrow-forward"></i></a></span> <span>Details de voitures <i class="ion-ios-arrow-forward"></i></span></p>
            <h1 class="mb-3 bread">Details de vehicules</h1>
          </div>
        </div>
      </div>
    </section>
      	...
      	<div class="row justify-content-center">
      		<div class="col-md-12">
      			<div class="car-details">
      				<div class="img rounded" style="background-image: url(uploads/bg_1.jpg);"></div>
						...
						<div class="bd-example bd-example-tabs">
						  ...
						  <div class="tab-content" id="pills-tabContent">
						    ...
						    <div class="tab-pane fade" id="pills-manufacturer" role="tabpanel" aria-labelledby="pills-manufacturer-tab">
						      <p>Même le tout-puissant Pointing n'a aucun contrôle sur les textes aveugles, c'est une vie presque non orthographique. Un jour cependant, une petite ligne de texte aveugle du nom de Lorem Ipsum décida de partir pour le monde lointain de la grammaire.</p>
									<p>Lorsqu'elle atteignit les premières collines des montagnes Italiques, elle eut une dernière vue sur l'horizon de sa ville natale Bookmarksgrove, le haut d'Alphabet Village et la ligne secondaire de sa propre route, la Line Lane. Une question rhétorique pitoyable lui parcourut la joue, puis elle continua son chemin.</p>
						    </div>
						      ...
						      <div class="row">
							   		<div class="col-md-7">
							   			...
							   			<div class="review d-flex">
									   		<div class="user-img" style="background-image: url(uploads/person_1.jpg)"></div>
									   		<div class="desc">
									   			<h4>
									   			...
									   			<p>Lorsqu'elle atteignit les premières collines des montagnes italiques, elle eut une dernière vue sur l'horizon de sa ville natale Bookmarksgrov</p>
									   		</div>
									   	</div>
									   	<div class="review d-flex">
									   		<div class="user-img" style="background-image: url(uploads/person_2.jpg)"></div>
									   		<div class="desc">
									   			<h4>
									   				<span class="text-left">Jacob Webb</span>
									   				<span class="text-right">14 March 2018</span>
									   	...
									   	<div class="review d-flex">
									   		<div class="user-img" style="background-image: url(uploads/person_3.jpg)"></div>
									   		<div class="desc">
									   			<h4>
									   				<span class="text-left">Jacob Webb</span>
									   				<span class="text-right">14 March 2018</span>
    ...
    <section class="ftco-section ftco-no-pt">
    	<div class="container">
          ...
          <div class="col-md-12 heading-section text-center ftco-animate mb-5">
          	<span class="subheading">Chisir la voiture</span>
            <h2 class="mb-2">Voitures similaires</h2>
          </div>
        </div>
        <div class="row">
        	<div class="col-md-4">
