...
// Vérifiez si un administrateur existe déjà dans la base de données
$query = "SELECT * FROM users WHERE role = 'admin'";
$result = mysqli_query($connect, $query);
$is_admin_exists = mysqli_num_rows($result) > 0;
...
<nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
        ...
        <div class="container">
          <div class="row no-gutters slider-text js-fullheight align-items-end justify-content-start">
            <div class="col-md-9 ftco-animate pb-5">
                <p class="breadcrumbs"><span class="mr-2"><a href="index.php">Acceuil <i class="ion-ios-arrow-forward"></i></a></span> <span>S'inscrire <i class="ion-ios-arrow-forward"></i></span></p>
              <h1 class="mb-3 bread">S'inscrire</h1>
            </div>
          </div>
        </div>
    </section>
                  ...
                  <div class="row mb-5">
                    <div class="col-md-12">
                        <div class="border w-100 p-4 rounded mb-2 d-flex">
                          ...
                          <p><span>Addresse:</span> Benin, Suite 721 Porto-Novo 10016</p>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="border w-100 p-4 rounded mb-2 d-flex">
                          ...
                          <p><span>Tel:</span> <a href="tel://43452406">+229 0143452406</a></p>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="border w-100 p-4 rounded mb-2 d-flex">
                          ...
                          <p><span>Email:</span> <a href="mailto:junaidniktab121@gmail.com">info@carbook.com</a></p>
                        </div>
                    </div>
                  </div>
            </div>
            <div class="col-md-8 block-9 mb-md-5">
            <form action="traitementregister.php" class="bg-light p-5 contact-form" method="post">
    ...
    <!-- Si aucun administrateur n'existe, afficher l'option de rôle -->
    ...
    <?php else: ?>
        <!-- Si un admin existe déjà, attribuer automatiquement le rôle 'user' -->
